...
class TenantsController {
    ...
    async create(req, res) {
        try {
            ...
            const licenseInfo = license_1.LicenseManager.generateLicenseKey(data.name, data.subscription_days || 365);
            const dbName = license_1.LicenseManager.createDbName(licenseInfo.license_key);
            ...
            const adminUser = await prisma.user.create({
                data: {
                    ...
                    password_hash: (0, security_1.hashPassword)(adminPassword),
                    is_admin: true,
